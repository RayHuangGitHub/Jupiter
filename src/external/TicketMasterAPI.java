...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "7ilDSwOGgxljIByTEOx03fbChYR3cHHv";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			keyword = URLEncoder.encode(keyword, "UTF-8"); // rui huang -> rui%20huang
		...
		try {
			...
			System.out.println("Response Code: " + responseCode); // code 200 is OK
			
			// we are clients ~ inputs
			// connections between clients and servers
			// outputStream(): requests, clients' outputs
